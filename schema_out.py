...
class Capacity(Base):
    ...
    units = sa.Column(sa.DOUBLE_PRECISION(), nullable=False)
...
class Client(Base):
    ...
    currency = sa.Column(sa.Text(), nullable=False, server_default='EUR' )
    tax = sa.Column(sa.DOUBLE_PRECISION())
    working_hours = sa.Column(sa.DOUBLE_PRECISION(), server_default='8')
...
class Invite(Base):
    ...
    consultancy_percentage = sa.Column(sa.DOUBLE_PRECISION(), nullable=False, server_default='100')
    relation = sa.Column(sa.Text())
    country = sa.Column(sa.Text(), nullable=False)
    rate = sa.Column(sa.DOUBLE_PRECISION())
    ...
    role = sa.Column(sa.Text(), nullable=False, server_default='user' )
...
class Invoice(Base):
    ...
    total_amount = sa.Column(sa.DOUBLE_PRECISION(), nullable=False)
    discount = sa.Column(sa.DOUBLE_PRECISION())
    ...
    org_id = sa.Column(sa.Text(), nullable=False)
    client_tax = sa.Column(sa.DOUBLE_PRECISION())
...
class InvoiceLine(Base):
    ...
    price = sa.Column(sa.DOUBLE_PRECISION(), nullable=False)
    amount = sa.Column(sa.DOUBLE_PRECISION(), nullable=False)
    total = sa.Column(ARRAY(sa.DOUBLE_PRECISION()))
...
class Project(Base):
    ...
    price = sa.Column(sa.DOUBLE_PRECISION(), nullable=False)
    units_total = sa.Column(sa.DOUBLE_PRECISION(), nullable=False)
...
class Rate(Base):
    ...
    hours = sa.Column(sa.DOUBLE_PRECISION())
...
class TempTable(Base):
    ...
    price = sa.Column(sa.DOUBLE_PRECISION())
    units_total = sa.Column(sa.DOUBLE_PRECISION())
